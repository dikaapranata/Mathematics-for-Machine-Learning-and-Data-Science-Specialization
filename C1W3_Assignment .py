...
def T_rotation_and_stretch(theta, a, v):
    ...
    # Define the stretching transformation matrix
...
def update_parameters(parameters, Y_hat, X, Y, learning_rate):
    """
    Update parameters using gradient descent
    
    Arguments:
    parameters -- python dictionary containing your parameters 
    Y_hat -- the output of forward propagation (output of the last activation)
    ...
    # Store updated parameters in dictionary
    parameters = {"W": W, "b": b}
...
def predict(X, parameters):
    """
    Predicts the output values for given input data using the learned parameters.

    Arguments:
    X -- input data of shape (n_x, m), where n_x is the dimension of input and m is the number of examples
    parameters -- dictionary containing the learned parameters 'W' and 'b'

    Returns:
    Z -- array of predicted output values
    """
    W = parameters['W']
    b = parameters['b']
